...
})({"53okF":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a4ddd9057a23c71b";
"use strict";
...
},{}],"hLCFx":[function(require,module,exports) {
/**
 ...
 */ L.Control.SidePanel = L.Control.extend({
    ...
    addTo: function(map) {
        ...
        // Enable dark mode
        if (this.options.darkMode) L.DomUtil.addClass(this._panel, "sidepanel-dark");
        ...
        if (this.options.hasTabs) this.initTabs(map, this.options.tabsPosition);
    },
    initTabs: function(map, tabsPosition) {
        if (typeof tabsPosition === "string") L.DomUtil.addClass(this._panel, "tabs-" + tabsPosition);
            ...
            L.DomEvent.on(tabLink, "click", function(e) {
                ...
                if (!L.DomUtil.hasClass(tabLink, "active")) {
                    ...
                    for(let i = 0; i < tabsLinks.length; i++){
                        ...
                        if (L.DomUtil.hasClass(linkActive, "active")) L.DomUtil.removeClass(linkActive, "active");
                    }
                    ...
                    tabsContents.forEach(function(element) {
                        if (tabLink.dataset.tabLink === element.dataset.tabContent) L.DomUtil.addClass(element, "active");
                        else L.DomUtil.removeClass(element, "active");
                    });
                }
            }, tabLink);
        }).bind(this));
    ...
    _toggleButton: function(map) {
        ...
        L.DomEvent.on(button, "click", (function(e) {
            ...
            } else L.DomUtil.addClass(this._panel, "opened");
...
},{}]},["53okF","hLCFx"], "hLCFx", "parcelRequire31ee")

//# sourceMappingURL=index.7a23c71b.js.map
